  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        >
          <DialogTitle>
            <Typography level="title-lg" sx={{ color: "hsl(215, 15%, 75%)" }}>
              What's Next
            </Typography>
          </DialogTitle>
          <ModalClose />
          ...
          <DialogContent sx={{ gap: 2 }}>
            ...
            <FormControl orientation="horizontal">
              <Box sx={{ flex: 1, pr: 1 }}>
                <FormLabel
                  sx={{ typography: "title-sm", color: "hsl(215, 15%, 75%)" }}
                >
                  Instant booking
                </FormLabel>
                <FormHelperText
                  sx={{ typography: "body-sm", color: "hsl(215, 15%, 75%)" }}
                >
